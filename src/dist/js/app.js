...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _cms__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cms */ "./resources/js/cms.ts");
/* harmony import */ var _cms__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_cms__WEBPACK_IMPORTED_MODULE_0__);
...
var toast_1 = __importDefault(__webpack_require__(/*! ./toast */ "./resources/js/toast.ts"));
var CMS = /** @class */ (function () {
    function CMS() {
        this.editables = document.querySelectorAll('[data-editable]');
        this.editables.forEach(function (content) {
            ...
            content.onkeydown = function (e) {
                if (e.keyCode === 13) {
                    var data_1 = {};
                    var intent = e.target.dataset.editable;
                    var type = e.target.dataset.editableType;
                    var field = e.target.dataset.editableField;
                    document.querySelectorAll('[data-editable="' + intent + '"]').forEach(function (e) {
                        data_1[e.dataset.editableField] = e.textContent;
                    });
                    toast_1.default.open({ type: 'info', message: 'Updating.' });
                    axios_1.default.post('/uniben/cms/update', { intent: intent, type: type, field: field, data: data_1 })
                        .then(function (res) {
                        toast_1.default.success('Updated!');
                        setTimeout(function () { return location.reload(); }, 200);
                    })
                        .catch(function (err) {
                        toast_1.default.error('There was an error updating the page!');
...
Object.defineProperty(exports, "__esModule", { value: true });
var notyf_1 = __webpack_require__(/*! notyf */ "./node_modules/notyf/notyf.es.js");
var toast = new notyf_1.Notyf({
    duration: 1500,
    types: [
        {
            type: 'info',
...
__webpack_require__(/*! /Users/work/PhpstormProjects/cms/src/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/work/PhpstormProjects/cms/src/resources/sass/app.scss */"./resources/sass/app.scss");
